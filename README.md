...
2. 설정 항목을 입력합니다.
   ...
   - **월사용 센서**: kWh 단위의 월사용량 센서를 추가합니다.(sensor 도메인만 가능하며, 소숫점 자리는 무시하고 정수만 계산됩니다.)
   - **계약 종별**: 주택용 저압 / 주택용 고압
   - **주거 구분**: 주거용 / 비주거용
   - **복지 할인**: 장애인, 국가유공자 등등
...
- 2026/02/11 V1.2.3 HA 재시작 초기 에러 발생 수정(기능 변환 없음)
- 2026/03/25 V1.2.4 HA 단위를 '원'에서 'KRW'로 변경, Deviceclass & Stateclass 추가
